...
export interface NullableSchema<T> extends BaseSchema<T | null> { readonly _type: "nullable"; unwrap(): BaseSchema<T>; }
export interface NullishSchema<T> extends BaseSchema<T | null | undefined> { readonly _type: "nullish"; unwrap(): BaseSchema<T>; }
...
export function nullable<T>(schema: BaseSchema<T>): NullableSchema<T> { return new NullableSchemaImpl(schema); }
export function nullish<T>(schema: BaseSchema<T>): NullishSchema<T> { return new NullishSchemaImpl(schema); }
